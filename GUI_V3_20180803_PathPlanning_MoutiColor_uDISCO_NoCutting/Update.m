...
if handles.Planning.Value==1
    ...
    StepStage=FOVImaging - FOVImaging*OverlapImaging/100; % Step real size, um
...
% query(Wheel, FilterStr(FilterState), '%c\n'); 
...
LeftBlueVoltage=10; % voltage to represent the light intensity
RightBlueVoltage=10;

LeftYellowVoltage=10;
RightYellowVoltage=10;
...
SaveFolder='D:\WholeBrainImagingData\20210722_SHANEL_2mm_monkey\Stack_1\';
