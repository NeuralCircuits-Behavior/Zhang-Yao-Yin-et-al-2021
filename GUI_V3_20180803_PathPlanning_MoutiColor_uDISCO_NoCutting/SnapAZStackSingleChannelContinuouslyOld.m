...
for lig=1:3
    ...
    if lig==1
        if BlueImaging~=1
            ...
            ColorRight=ColorRightBlue;
            ColorLeft=ColorLeftBlue;
            LightVoltageLeft=LeftBlueVoltage;
            LightVoltageRight=RightBlueVoltage;
            CurrentColor=1;
    ...
    if lig==3
        if RedImaging~=1
            ...
            ColorRight=ColorRightRed;
            ColorLeft=ColorLeftRed;
            LightVoltageLeft=LeftRedVoltage;
            LightVoltageRight=RightRedVoltage;
            CurrentColor=3;
